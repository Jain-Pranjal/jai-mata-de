...
import { banashankariContent } from "@/content/banashankari";



const BanashankariPage = () => {
    const { selectedLanguage } = useLanguageStore();
    const displayLanguage = selectedLanguage || "english";

    const content = banashankariContent[displayLanguage as keyof typeof banashankariContent] || banashankariContent.english;
...
export default BanashankariPage;