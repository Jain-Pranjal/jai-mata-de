...
import { sakraiDhamContent } from "@/content/sakraiDham";


const SakraiDhamPage = () => {
    const { selectedLanguage } = useLanguageStore();
    const displayLanguage = selectedLanguage || "english";

    const content = sakraiDhamContent[displayLanguage as keyof typeof sakraiDhamContent] || sakraiDhamContent.english;
