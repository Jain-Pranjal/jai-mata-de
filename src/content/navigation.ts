...
export const navigationContent: Record<Language, NavigationContent> = {
  ...
  kannada: {
    title: "ನಮ್ಮನ್ನು ಹೇಗೆ ತಲುಪುವುದು",
    byAir: {
      heading: "ಹವಾಯು ಮಾರ್ಗದಿಂದ",
      description: "ನಿಕಟದ ವಿಮಾನ ನಿಲ್ದಾಣ: ಡೆಹ್ರಾಡೂನ್",
    },
    byTrain: {
      heading: "ರೈಲು ಮೂಲಕ",
      nearestStation: "ನಿಕಟದ ರೈಲು ನಿಲ್ದಾಣ: ಸಹಾರನ್‌ಪುರ್",
      fromDelhi: {
        heading: "ದಿಲ್ಲಿಯಿಂದ ಸಹಾರನ್‌ಪುರ್‌ಗೆ",
        details: [
          "ರೈಲು: ಶತಾಬ್ದಿ ಎಕ್ಸ್‌ಪ್ರೆಸ್ (12017)",
          "ಬಯಲುದುರು: ನ್ಯೂ ದೆಹಲಿ ನಿಲ್ದಾಣ (NDLS) ಬೆಳಿಗ್ಗೆ 06:45ಕ್ಕೆ",
          "ಆಗಮನ: ಸಹಾರನ್‌ಪುರ್ ನಿಲ್ದಾಣ (SRE) ಬೆಳಿಗ್ಗೆ 09:50ಕ್ಕೆ",
          "ನಿಲ್ಲಿಸುತ್ತದೆ: 4 ನಿಲ್ಲುತ್ತದೆ",
        ],
      },
      toDelhi: {
        heading: "ಸಹಾರನ್‌ಪುರ್‌ನಿಂದ ದಿಲ್ಲಿಗೆ",
        details: [
          "ರೈಲು: ಡೆಹ್ರಾಡೂನ್ ಶತಾಬ್ದಿ (12018)",
          "ಬಯಲುದುರು: ಸಹಾರನ್‌ಪುರ್ ರಾತ್ರಿ 19:50ಕ್ಕೆ",
          "ಅವಧಿ: 2 ಗಂಟೆಗಳು 55 ನಿಮಿಷಗಳು",
          "ಆಮ್ಲಜನಕದ ಪರ್ಯಾಯ ಮಾರ್ಗಗಳು : ಜಾಲಂಧರ್ ನಗರ ನ್ಯೂ ದೆಹಲಿ ಎಕ್ಸ್‌ಪ್ರೆಸ್ (14682)",
          "ಬಯಲುದುರು : ಸಹಾರನ್‌ಪುರ್ ಬೆಳಿಗ್ಗೆ 09:20ಕ್ಕೆ",
          "ಅವಧಿ : 3 ಗಂಟೆಗಳು 30 ನಿಮಿಷಗಳು",
        ],
      },
    },
    byRoad: {
      heading: "ರಸ್ತೆ ಮೂಲಕ",
      description:
        "ಈ ದೇವಸ್ಥಾನವು ಕೆಳಗಿನ ಸ್ಥಳಗಳಿಂದ ರಸ್ತೆಯ ಮೂಲಕ ಚೆನ್ನಾಗಿ ಸಂಪರ್ಕಿತವಾಗಿದೆ:",
      routes: ["ಸಹಾರಾನ್‌ಪುರ್", "ಚುಟ್‌ಮಲ್ಪುರ್ (ಬೆಹತ್ ಮೂಲಕ)", "ದಿಲ್ಲಿಯಿಂದ ಸಹಾರಾನ್‌ಪುರ್ ಮಾರ್ಗ ಲಭ್ಯವಿದೆ"],
    },
    locationMap: {
      heading: "ಸ್ಥಳದ ನಕ್ಷೆ",
    },
